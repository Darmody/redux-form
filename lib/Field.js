  ...
  var Field = function (_Component) {
    ...
    _createClass(Field, [{
      ...
      value: function shouldComponentUpdate(nextProps, nextState) {
        var syncError = this.getSyncError();
      ...
      key: 'getSyncError',
      value: function getSyncError() {
        var syncErrors = this.context._reduxForm.syncErrors;

        var error = _plain2.default.getIn(syncErrors, this.props.name);
