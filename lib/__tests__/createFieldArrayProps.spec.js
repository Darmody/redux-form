...
var describeCreateFieldProps = function describeCreateFieldProps(name, structure, expect) {
  ...
  describe(name, function () {
    ...
    it('should provide errors', function () {
      expect(_createFieldArrayProps2.default.apply(undefined, defaultProps.concat([{}, 'Sync Error'])).fields.error).toBe('Sync Error');
      expect(_createFieldArrayProps2.default.apply(undefined, defaultProps.concat([{}, 'Sync Error'])).fields.valid).toBe(false);
      expect(_createFieldArrayProps2.default.apply(undefined, defaultProps.concat([{}, 'Sync Error'])).fields.invalid).toBe(true);
      expect(_createFieldArrayProps2.default.apply(undefined, defaultProps.concat([{
