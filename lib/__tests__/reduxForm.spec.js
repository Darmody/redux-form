...
var describeReduxForm = function describeReduxForm(name, structure, combineReducers, expect) {
  ...
  describe(name, function () {
    ...
    it('should initialize with initialValues on later render', function () {
      var store = makeStore({});
      var inputRender = (0, _expect.createSpy)(function (props) {
        return _react2.default.createElement('input', props);
      }).andCallThrough();
      ...
      expect(formRender).toHaveBeenCalled();
      expect(formRender.calls.length).toBe(1);
      var checkFormProps = function checkFormProps(props) {
        expect(props.pristine).toBe(true);
        expect(props.dirty).toBe(false);
          ...
          value: function render() {
            ...
            return _react2.default.createElement(
              ...
              _react2.default.createElement(
                'button',
                { onClick: function onClick() {
                    return _this9.setState({ showForm: !showForm });
                  } },
                'Toggle'
              )
            );
          ...
          value: function render() {
            ...
            return _react2.default.createElement(
              ...
              _react2.default.createElement(
                'button',
                { onClick: function onClick() {
                    return _this12.setState({ showForm: !showForm });
                  } },
                'Toggle'
              )
            );
          ...
          value: function render() {
            ...
            return _react2.default.createElement(
              ...
              _react2.default.createElement(
                'button',
                { onClick: function onClick() {
                    return _this14.setState({ showBar: true });
                  } },
                'Show Bar'
              )
            );
    ...
    it('should mark all fields as touched on submit', function () {
      ...
      var password = (0, _expect.createSpy)(function (props) {
        return _react2.default.createElement('input', _extends({}, props, { type: 'password' }));
      }).andCallThrough();
    ...
    it('should rerender form, but not fields, when non-redux-form props change', function () {
      ...
      var Container = function (_Component12) {
        ...
        function Container(props) {
          ...
          var _this16 = _possibleConstructorReturn(this, Object.getPrototypeOf(Container).call(this, props));
          ...
          value: function render() {
            ...
            return _react2.default.createElement(
              ...
              _react2.default.createElement(
                'button',
                { onClick: function onClick() {
                    return _this17.setState({ someOtherProp: 42 });
                  } },
                'Init'
              )
            );
